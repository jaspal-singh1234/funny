...
{
echo '<script> var x=window.confirm("your atm account has not been created firstly create your atm account ! press ok"); if(x==true) { window.location.href="http://localhost/jaspal/create2.php"; } else { window.location.href="http://localhost/jaspal/deposit2.php"; } </script>';
}
}
?>