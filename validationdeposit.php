...
{
echo '<script> var x=window.confirm("your account has not been created firstly create your account ! press ok"); if(x==true) { window.location.href="http://localhost/jaspal/create.php"; } else { window.location.href="http://localhost/jaspal/deposit.php"; } </script>';
}
}
?>