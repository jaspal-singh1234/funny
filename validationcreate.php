...
if($con->query($q)===true)
{
echo '<script> var x= window.confirm("your account has been registered successfully now you login on your atm account press ok");  if(x==true) { window.location.href="http://localhost/jaspal/demo.php"; } else { window.location.href="http://localhost/jaspal/create.php"; }</script>';
}
else
{
